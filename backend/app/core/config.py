...
class Settings(BaseSettings):
    ...
    # === Project ===
    PROJECT_NAME: str = "my_ai_agent"
    API_V1_STR: str = "/api/v1"
    DEBUG: bool = False
    ENVIRONMENT: Literal["development", "local", "staging", "production"] = "local"
    TIMEZONE: str = (
        "Americas/Los_Angeles"  # IANA timezone (e.g. "UTC", "Europe/Warsaw", "America/New_York")
    )
    ...
    LOGFIRE_SERVICE_NAME: str = "my_ai_agent"
    ...
    STRIPE_TRIAL_DAYS_DEFAULT: int = 180
