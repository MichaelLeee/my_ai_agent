...
BEGIN
    ...
    FOR i IN 1..50 LOOP
        ...
        VALUES (
            ...
            true,
            '$2y$10$ByyXYNLK1P/FxHGFNFtI.Oi1pf0SIuSaYm816SzbkTxPv6Im0Njf2',
            i <= 2,
    ...
    FOR i IN 1..50 LOOP
        ...
        VALUES (
            ...
            i <= 4,
            CASE WHEN i <= 3 THEN NULL ELSE user_ids[1 + (i % array_length(user_ids,1))] END,
    ...
    -- ═══════════════════════════════════════════════════════════════════════
    -- 8. NOTES (50) + NOTE LINKS + INSIGHTS
    -- ═══════════════════════════════════════════════════════════════════════
    DECLARE
...
-- Update all users to the same known password: thinkagain
UPDATE users SET hashed_password = '$2y$10$ByyXYNLK1P/FxHGFNFtI.Oi1pf0SIuSaYm816SzbkTxPv6Im0Njf2';
